...
import type { Logistics,Express } from '@/types/medicine'
...
window._AMapSecurityConfig = {
  securityJsCode: '7fff7ae35ddcbbd9b355282d71897fd2'
}
onMounted(async () => {
  // ... 省略 ...
  AMapLoader.load({
    ...
    const map = new AMap.Map("map",{  //设置地图容器id
      ...
      AMap.plugin('AMap.Driving',()=>{//异步加载插件
     //构造路线导航类
    ...
    const start = [116.379028, 39.865042]
    const end = [116.427281, 39.903719]
    // 根据起终点经纬度规划驾车导航路线
    driving.search(start, end,{waypoints:[108.954547,34.386498]}, (status:string, result:object)=> {
